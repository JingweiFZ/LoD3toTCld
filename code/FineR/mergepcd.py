...
def mergepcd(file_dir, save_filename):
    "merge text files"
    ...
    with open(save_filename, 'w') as merged_file:
        ...
        for file_name in file_names:
            ...
            with open(file_dir+file_name, 'rb') as current_file:
                # 读取当前文件的内容并写入合并后的文件
...
if __name__ == '__main__':
    file_dir='G:/Application/Ref_render/calibrated/'
    filename=''
    save_filename='G:/Application/Ref_render/calibrated/Whole.txt'

    mergepcd(file_dir,save_filename)