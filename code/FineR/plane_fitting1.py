...
if __name__ == "__main__":
    ...
    # 将源点云移动到目标点云的质心位置
    point_cloud2 = point_cloud2.translate(vec)
    ...
    point_cloud2.transform(np.linalg.inv(reg_p2l.transformation))
    ...
    translation_matrix = np.dot(np.linalg.inv(reg_p2l.transformation), translation_matrix)
